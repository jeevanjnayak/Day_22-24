...
public class AddressBookMethods {
    ...
    public boolean checkDuplicateName(String firstName ,String lastName) {
        ...
        for (AddressBook addressBook : contact) {
            if (addressBook.getFirstName().equals(firstName) && addressBook.getLastName().equals(lastName)) {
                duplicate = true;
                break;
            }
        }
    ...
    public void searchPersonByState(String state) {
        ArrayList<AddressBook> list = (ArrayList<AddressBook>) contact.stream().filter(contactName -> contactName.getState().equals(state)).toList();
    ...
    public void searchPersonByCity(String city2) {
        ArrayList<AddressBook> list = (ArrayList<AddressBook>) contact.stream().filter(contactName -> contactName.getCity().equals(city)).toList();
        for (AddressBook contact : list) {
    ...
    public void viewPersonByState(String state) {
        List<AddressBook> list = contact.stream().filter(contactName -> contactName.getState().equals(state)).toList();
        for (AddressBook contact : list) {
            System.out.println("Name: " + contact.getFirstName() +" "+ contact.getLastName());
    ...
    public void viewPersonByCity(String city2) {
        List<AddressBook> list = contact.stream().filter(contactName -> contactName.getCity().equals(city)).toList();
        for (AddressBook contact : list) {
            System.out.println("First Name: " + contact.getFirstName()+ "  " + contact.getLastName());
